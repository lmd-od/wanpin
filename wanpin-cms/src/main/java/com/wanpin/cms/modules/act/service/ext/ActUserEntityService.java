 ...
 */
package com.wanpin.cms.modules.act.service.ext;
...
import com.wanpin.cms.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.wanpin.cms.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.wanpin.cms.modules.sys.entity.User(null, userId)))){
